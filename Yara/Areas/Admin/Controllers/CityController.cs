...
namespace Yara.Areas.Admin.Controllers
{
    ...
    public class CityController : Controller
    {
		...
		[HttpPost]
		[AutoValidateAntiforgeryToken]
		public async Task<IActionResult> SaveAr(ViewmMODeElMASTER model, City slider, List<IFormFile> Files, string returnUrl)
		{
			try
			{
				slider.Id = model.City.Id;
				...
				if (slider.Id == 0 || slider.Id == null)
				{
					...
					{
						TempData["Description"] = ResourceWeb.VLDescriptionDoplceted;
						return RedirectToAction("AddCityAr", model);
					}
					...
					{
						TempData["Saved successfully"] = ResourceWeb.VLSavedSuccessfully;
						return RedirectToAction("MyCityAr");
					}
					else
					{
						TempData["ErrorSave"] = ResourceWeb.VLErrorSave;
