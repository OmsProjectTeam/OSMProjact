...
namespace Yara.Areas.merchantAccount.Controllers
{
    ...
    public class ChatController : Controller
    {
        ...
        [HttpGet]
        [Route("/merchantAccount/Chat/OwnChat/{anotherId}")]
        ...
        [HttpGet]
        [Route("/merchantAccount/Chat/OwnChatAr/{anotherId}")]
        ...
        [HttpPost]
        [Route("merchantAccount/Chat/UploadFile")]
        ...
        [HttpGet]
        [Route("/merchantAccount/Chat/GetMessages")]
